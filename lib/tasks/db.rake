...
namespace :db do
  ...
  task create: [:environment] do
    ...
    con.execute("DROP ROLE #{aact_superuser};")
    con.execute("CREATE ROLE #{aact_superuser} LOGIN SUPERUSER PASSWORD 'aact_2_password';")
    ...
    con.execute("GRANT ALL ON ALL TABLES IN SCHEMA public TO #{aact_superuser};")
